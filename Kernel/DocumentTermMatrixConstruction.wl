...
BeginPackage["AntonAntonov`MonadicLatentSemanticAnalysis`DocumentTermMatrixConstruction`"];
...
ApplyLocalTermFunction[ docTermMat_?MatrixQ, funcName_String] :=
    Block[{},
      ...
      Which[
        ...
        Log[ UnitStep[docTermMat] + docTermMat ],
...
GlobalTermFunctionWeights[ docTermMat_?MatrixQ, funcName_String] :=
    Block[{mat, globalWeights, freqSums},
      ...
      Which[
        ...
        globalWeights = Log[2, Dimensions[mat][[1]] / (1.0 + globalWeights)];
