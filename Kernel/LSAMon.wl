...
(* :Discussion:
  ...
  # Usage example
      ...
      res =
        LSAMonUnit[texts]\[DoubleLongRightArrow]
        LSAMonMakeDocumentTermMatrix[{}, Automatic]\[DoubleLongRightArrow]
        LSAMonApplyTermWeightFunctions[]\[DoubleLongRightArrow]
      ...
      res\[DoubleLongRightArrow]
        LSAMonExtractStatisticalThesaurus[{"arms", "banking", "economy", "education", "freedom", "tariff", "welfare"}, 6]\[DoubleLongRightArrow]
        LSAMonRetrieveFromContext["statisticalThesaurus"]\[DoubleLongRightArrow]
        LSAMonEchoValue\[DoubleLongRightArrow]
    ...
    Block[{logBase, paretoQ, echoQ, texts, logFunc, logInsert, dOpts, smat, res},
      ...
      res =
          Grid[{
            ...
            If[ paretoQ,
              {
                ResourceFunction["ParetoPrinciplePlot"][ ColumnSums[ context["documentTermMatrix"] ], FrameLabel -> {"Terms", "Occurrences"}, dOpts ],
                ResourceFunction["ParetoPrinciplePlot"][ Total[smat], FrameLabel -> {"Terms", "Documents"}, dOpts ],
                ResourceFunction["ParetoPrinciplePlot"][ Total[Transpose[smat]], FrameLabel -> {"Documents", "Terms"}, dOpts ]
              },
              Nothing
            ]
          }];
